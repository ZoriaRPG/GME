...
extern gme_err_t gme_load_m3u( Music_Emu* me, const char* path ) { return me->load_m3u( path ); }
//BLARGG_EXPORT 
extern gme_err_t gme_load_m3u_data( Music_Emu* me, const void* data, long size )
//BLARGG_EXPORT 
{
